...
pub static MODERATOR_PRINCIPALS: Lazy<Vec<Principal>> = Lazy::new(|| {
    vec![
        "o7soq-c4ync-cfs3n-i5qbs-472zl-nbxlh-df7r4-2uqpz-svjpz-7ktda-dae".parse().unwrap(),
        "ai5pa-6geuw-2fe7h-oi5vs-fd3rd-unvxq-44jhj-ze2dx-gxl6k-us473-qqe".parse().unwrap(),
    ]
});
