...
pub async fn generate_with_context(
    ...
    if use_webhook {
        ...
        info!("Using webhook for Wan 2.5 Fast prediction {}, returning immediately", prediction_response.id);
        Ok(VideoGenResponse {
        ...
        info!("Using polling for Wan 2.5 Fast prediction {}", prediction_response.id);
